...
\author{Alicja Łuszczak, Juliusz Sompolski}

\nralbumu{248265, 248396}

\title{Normy społeczne prowadzące do kooperacji w interakcjach wieloosobowych}

\tytulang{Social norms leading to cooperation in multiperson interactions}

\kierunek{Matematyka}

\opiekun{dra hab. Tadeusza Płatkowskiego, prof. UW\\
...
\klasyfikacja{91-XX. Game theory, economics, social and behavioral sciences\\
  91Axx. Game theory\\
  91A06. $n$-person games, $n>2$}

\keywords{normy społeczne, $n$-osobowy dylemet więźnia}
...
\bibitem{suzuki2007}
S. Suzuki, E. Akiyama, 2007. Three-person game facilitates indirect reciprocity under image scoring, J. Theor. Biol. 249, 93–100
